      ...
      const account = await prisma.financialAccount.update({
        ...
        data: {
          ...
          ...(body.interestRate !== undefined
            ...
            : {}),
          ...(body.promoBalance !== undefined
            ? {
                promoBalance: body.promoBalance,
              }
            : {}),
          ...(body.promoInterestRate !== undefined
            ? {
                promoInterestRate: body.promoInterestRate,
              }
            : {}),
          ...(body.promoEndsAt !== undefined
            ? {
                promoEndsAt: body.promoEndsAt
                  ? new Date(`${body.promoEndsAt}T12:00:00`)
                  : null,
              }
            : {}),
